...
<<<<<<<< HEAD:TwenGo/TwenGo/Migrations/20220103222437_initial.Designer.cs
using TwenGo.Models.Repository;

namespace TwenGo.Migrations
{
    [DbContext(typeof(TwenGoContext))]
    [Migration("20220103222437_initial")]
...
namespace TwenGo.Migrations
{
    ...
    [Migration("20220105020344_add_group")]
    partial class add_group
>>>>>>>> main:TwenGo/TwenGo/Migrations/20220105020344_add_group.Designer.cs
    {
            ...
            modelBuilder.Entity("TwenGo.Models.Repository.Entity.Users", b =>
                {
                    ...
                    b.ToTable("AspNetUsers");
========
            modelBuilder.Entity("TwenGo.Data.Category", b =>
                {
            ...
            modelBuilder.Entity("TwenGo.Data.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
...
========
            modelBuilder.Entity("TwenGo.Data.Product", b =>
                {
                    b.HasOne("TwenGo.Data.Category", null)
                        .WithMany("product")
